...
#define PIXEL_COUNT 	60     //定义RGB LED的数量
#define PIXEL_TYPE	 	WS2811 //定义RGB LED的驱动类型

Adafruit_NeoPixel strip = Adafruit_NeoPixel(PIXEL_COUNT, PIXEL_PIN, PIXEL_TYPE);
WidgetLEDLightBar ledBar = WidgetLEDLightBar();
...
//灯条设置回调
void neopixelSetCb(void)
{
    mo_colour_bar.m_run_type = (run_type_t)ledBar.getMode();
    mo_colour_bar.m_brightness = ledBar.getBrightness();
    mo_colour_bar.m_led_long = ledBar.getLength();
    mo_colour_bar.m_colour = ledBar.getRGB();
